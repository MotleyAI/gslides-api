...
from gslides_api.domain import Size, Transform, Shape, Image, ShapeProperties, ShapeType, ImageReplaceMethod
...
def presentation_data():
    ...
    with open('tests/presentation_output.json', 'r') as f:
        return json.load(f)
...
class TestShapeElementWriteMethods:
    ...
    def test_write_plain_text_requests_not_implemented(self, slide_3_shape_element):
        ...
        with pytest.raises(NotImplementedError, match="Writing plain text to shape elements is not supported yet"):
    ...
    def test_write_markdown_requests(self, mock_processor, slide_3_shape_element):
        ...
        mock_processor.create_slides_requests.assert_called_once_with(
            slide_3_shape_element.objectId, 
            "# Test markdown"
        )
...
class TestImageElementReplaceImageRequests:
    ...
    def test_replace_image_requests_success(self, mock_validate):
        ...
        expected_request = [{"replaceImage": {"imageObjectId": "test_image", "url": "https://example.com/new_image.jpg"}}]
    ...
    def test_replace_image_requests_with_method(self, mock_validate):
        ...
        result = image_element.replace_image_requests("https://example.com/new_image.jpg", ImageReplaceMethod.CENTER_CROP)
