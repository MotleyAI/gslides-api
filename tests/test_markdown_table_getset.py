...
class TestMarkdownTableElementGetSet:
    ...
    def test_getitem_chaining_access(self):
        ...
        table_data = TableData(
            headers=["Product", "Price"], rows=[["Widget", "$10"], ["Gadget", "$20"]]
        )
    ...
    def test_getitem_negative_indices(self):
        ...
        table_data = TableData(headers=["A", "B"], rows=[["1", "2"], ["3", "4"]])
    ...
    def test_setitem_direct_assignment(self):
        ...
        table_data = TableData(headers=["Name", "Score"], rows=[["Alice", "85"], ["Bob", "92"]])
    ...
    def test_setitem_marko_validation_success(self):
        ...
        table_data = TableData(headers=["Name", "Value"], rows=[["A", "1"], ["B", "2"]])
    ...
    def test_setitem_preserves_table_structure(self):
        ...
        table_data = TableData(
            headers=["Col1", "Col2", "Col3"], rows=[["A", "B", "C"], ["D", "E", "F"]]
        )
    ...
    def test_setitem_type_errors(self):
        ...
        table_data = TableData(headers=["Name"], rows=[["Alice"]])
    ...
    def test_empty_table_errors(self):
        ...
        empty_table = MarkdownTableElement(name="Empty", content=TableData(headers=[], rows=[]))
...
| Bob   | 30 | SF  |"""
    ...
    def test_shape_property(self):
        ...
        table_data = TableData(headers=["A", "B", "C"], rows=[["1", "2", "3"], ["4", "5", "6"]])
        table = MarkdownTableElement(name="Matrix", content=table_data)
    ...
    def test_shape_property_single_row(self):
        ...
        table_data = TableData(headers=["Name", "Age"], rows=[["Alice", "25"]])
    ...
    def test_shape_property_header_only(self):
        ...
        table_data = TableData(headers=["Col1", "Col2", "Col3", "Col4"], rows=[])
    ...
    def test_shape_property_no_headers(self):
        ...
        table_data = TableData(headers=[], rows=[["a", "b"], ["c", "d"], ["e", "f"]])
    ...
    def test_shape_property_single_column(self):
        ...
        table_data = TableData(headers=["Item"], rows=[["Apple"], ["Banana"], ["Cherry"]])
    ...
    def test_shape_consistency_with_indexing(self):
        ...
        table_data = TableData(
            headers=["X", "Y", "Z"], rows=[["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"]]
        )
