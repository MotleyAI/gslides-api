...
from gslides_api.execute import upload_image_to_drive
...
class TestUploadImageToDrive:
    ...
    def test_supported_png_format(self):
        ...
        with patch('gslides_api.execute.creds') as mock_creds, \
             patch('gslides_api.execute.MediaFileUpload') as mock_media_upload, \
             patch('os.path.basename') as mock_basename:
            
            # Setup mocks
            mock_basename.return_value = "test_image.png"
            mock_drive_service = MagicMock()
            mock_creds.drive_service = mock_drive_service
            ...
            # Test PNG format
            result = upload_image_to_drive("test_image.png")
    ...
    def test_supported_jpeg_formats(self):
        ...
        for image_path, expected_mime_type in test_cases:
            with patch('gslides_api.execute.creds') as mock_creds, \
                ...
                # Test the format
                result = upload_image_to_drive(image_path)
    ...
    def test_supported_gif_format(self):
        ...
        with patch('gslides_api.execute.creds') as mock_creds, \
            ...
            # Test GIF format
            result = upload_image_to_drive("test_image.gif")
    ...
    def test_error_message_format(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            upload_image_to_drive("test_image.bmp")
