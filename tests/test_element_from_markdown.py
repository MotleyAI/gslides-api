...
class TestTextElementFromMarkdown:
    ...
    def test_simple_text_from_markdown(self):
        ...
        element = TextElement.from_markdown("MyText", "# Hello World")
...
More content here."""
        ...
        element = TextElement.from_markdown("Details", markdown_content)
    ...
    def test_text_with_whitespace_from_markdown(self):
        ...
        element = TextElement.from_markdown("Test", "  # Hello  \n\n  ")
    ...
    def test_empty_text_from_markdown(self):
        ...
        element = TextElement.from_markdown("Empty", "")
    ...
    def test_text_from_markdown_round_trip(self):
        ...
        element = TextElement.from_markdown("Test", original_markdown)
...
class TestImageElementFromMarkdown:
    ...
    def test_simple_image_from_markdown(self):
        ...
        element = ImageElement.from_markdown("MyImage", markdown)
    ...
    def test_image_without_alt_text_from_markdown(self):
        ...
        element = ImageElement.from_markdown("EmptyAlt", markdown)
    ...
    def test_image_with_complex_url_from_markdown(self):
        ...
        element = ImageElement.from_markdown("Complex", markdown)
    ...
    def test_image_with_local_path_from_markdown(self):
        ...
        element = ImageElement.from_markdown("Local", markdown)
    ...
    def test_image_with_whitespace_from_markdown(self):
        ...
        element = ImageElement.from_markdown("Whitespace", markdown)
    ...
    def test_invalid_image_markdown_raises(self):
        ...
        with pytest.raises(ValueError, match="Image element must contain at least one markdown image"):
            ImageElement.from_markdown("Invalid", "This is not an image")

    def test_text_without_image_raises(self):
        """Test that text without image markdown raises ValueError."""
        with pytest.raises(ValueError, match="Image element must contain at least one markdown image"):
            ImageElement.from_markdown("NoImage", "# Just a title\n\nSome text here")
    ...
    def test_image_from_markdown_round_trip(self):
        ...
        element = ImageElement.from_markdown("Sunset", original_markdown)
...
| Bob   | 30 |"""
        ...
        element = TableElement.from_markdown("People", markdown)
...
| Tool    | $5.50 | Yes      | New arrival  |"""
        ...
        element = TableElement.from_markdown("Inventory", markdown)
...
|   | 2 | 3 |"""
        ...
        element = TableElement.from_markdown("Sparse", markdown)
...
| 1 | 2 |
  """
        ...
        element = TableElement.from_markdown("Clean", markdown)
    ...
    def test_invalid_table_markdown_raises(self):
        ...
        with pytest.raises(ValueError, match="Table element must contain a valid markdown table"):
            TableElement.from_markdown("Invalid", "This is not a table")

    def test_text_without_table_raises(self):
        """Test that text without table markdown raises ValueError."""
        with pytest.raises(ValueError, match="Table element must contain a valid markdown table"):
            TableElement.from_markdown("NoTable", "# Title\n\nJust some text")
...
| Orange  | 5   |"""
        ...
        element = TableElement.from_markdown("Fruits", original_markdown)
...
```"""
        ...
        element = ChartElement.from_markdown("BarChart", markdown)
...
```"""
        ...
        element = ChartElement.from_markdown("SalesChart", markdown)
...
```  """
        ...
        element = ChartElement.from_markdown("Simple", markdown)
    ...
    def test_invalid_chart_format_raises(self):
        ...
        with pytest.raises(ValueError, match="Chart element must contain only a ```json code block"):
            ChartElement.from_markdown("Invalid", "This is not a JSON code block")

    def test_non_json_code_block_raises(self):
        """Test that non-JSON code block raises ValueError."""
        with pytest.raises(ValueError, match="Chart element must contain only a ```json code block"):
            ChartElement.from_markdown("Python", "```python\nprint('hello')\n```")

    def test_invalid_json_raises(self):
        """Test that invalid JSON raises ValueError."""
        with pytest.raises(ValueError, match="Chart element must contain valid JSON"):
            ChartElement.from_markdown("BadJSON", "```json\n{invalid json}\n```")
...
```"""
        ...
        element = ChartElement.from_markdown("MyChart", original_markdown)
...
class TestFromMarkdownIntegration:
    ...
    def test_all_element_types_from_markdown(self):
        ...
        text_elem = TextElement.from_markdown("Title", "# Welcome")
        image_elem = ImageElement.from_markdown("Logo", "![Logo](logo.png)")
        table_elem = TableElement.from_markdown("Data", "| A | B |\n|---|---|\n| 1 | 2 |")
        chart_elem = ChartElement.from_markdown("Chart", '```json\n{"data": [1, 2]}\n```')
    ...
    def test_from_markdown_methods_are_classmethods(self):
        ...
        classes = [TextElement, ImageElement, TableElement, ChartElement]
        ...
        for cls in classes:
            ...
            assert method.__self__ is cls, f"{cls.__name__}.from_markdown not bound to correct class"
...
| Bob   | 30 |"""
        ...
        markdown_elem = TableElement.from_markdown("People", markdown)
        parent_id = "slide123"
        ...
        object_ids = {getattr(req, 'objectId', None) for req in requests if hasattr(req, 'objectId')}
...
| 1 | 2 |"""
        ...
        markdown_elem = TableElement.from_markdown("Test", markdown)
        parent_id = "slide456"
...
| `Code` | Normal text |"""
        ...
        markdown_elem = TableElement.from_markdown("Products", markdown)
        parent_id = "slide789"
...
|   | 2 |   |"""
        ...
        markdown_elem = TableElement.from_markdown("Sparse", markdown)
...
| Banana |"""
        ...
        markdown_elem = TableElement.from_markdown("Items", markdown)
...
|------|------|------|"""
        ...
        markdown_elem = TableElement.from_markdown("HeaderOnly", markdown)
    ...
    def test_large_table_to_requests(self):
        ...
        markdown_elem = TableElement.from_markdown("LargeTable", markdown)
...
| A    | B    |"""
        ...
        markdown_elem = TableElement.from_markdown("Structure", markdown)
