# ==============================================================================
# DEPRECATED CODE - Replaced by IR-based conversion
#
# The functions in this file have been replaced by the platform-agnostic IR system:
# - text_elements_to_markdown() -> text_elements_to_ir() + ir_to_markdown()
# - _apply_markdown_formatting() -> _format_run_to_markdown() in ir_to_markdown.py
# - _is_numbered_list_glyph() -> converters._is_numbered_list_glyph()
# - _get_list_indentation() -> handled in ir_to_markdown._list_to_markdown()
# - _format_bullet_marker_with_nesting() -> handled in ir_to_markdown._list_to_markdown()
# - normalize_numbered_glyph() -> handled in ir_to_markdown._list_to_markdown()
#
# This code is kept temporarily for reference. Delete after confirming all tests pass.
# ==============================================================================
